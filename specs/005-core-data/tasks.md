...
- [x] T046 Ran `./scripts/test-wasm.sh` (`wasm-pack test --headless --chrome` from `shared/`) against locally-installed Chrome 149 + matching chromedriver 149. The one wasm test (the geometry reader) passes headless. Per spec SC-002 + SC-004.
