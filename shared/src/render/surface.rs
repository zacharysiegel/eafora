...
mod native {
    ...
    impl WgpuSurface {
        pub fn from_window_handle(
            ...
            let target: wgpu::SurfaceTargetUnsafe = window_handle_to_target(window_handle)?;
    ...
    fn window_handle_to_target(window_handle: WindowHandle) -> Result<wgpu::SurfaceTargetUnsafe, AppError> {
