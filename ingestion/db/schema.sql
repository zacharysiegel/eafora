...
--
-- Name: COLUMN artifact_version.data_source_versions_jsonb; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.artifact_version.data_source_versions_jsonb IS 'snapshot of every data_source''s data_source_revision at build time: {"wb_wdi": "2024-Q4", "hfd": "2025-12"}; used to attribute artifact contents to upstream snapshots and to let clients detect when re-fetching is worthwhile';
