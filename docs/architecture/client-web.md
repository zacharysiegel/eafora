...
│   │   ├── favicon.ico         # declared first, since Safari takes the first icon it can use
│   │   └── robots.txt
│   └── src/
